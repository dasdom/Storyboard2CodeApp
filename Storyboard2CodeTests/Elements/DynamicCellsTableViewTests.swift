...
class DynamicCellsTableViewTests: XCTestCase {
  ...
  func test_TableViewCodeString_HasBackgroundColorStatement() {
    let expectedString = "backgroundColor = UIColor(red: 0.937, green: 0.937, blue: 0.957, alpha: 1.000)"
    XCTAssertTrue(codeString.contains(expectedString))
  }
  
  func test_TableViewCodeString_HasSeparatorColorStatement() {
    let expectedString = "separatorColor = UIColor(red: 0.000, green: 0.502, blue: 0.000, alpha: 1.000)"
    XCTAssertTrue(codeString.contains(expectedString))
  }
  
  func test_TableViewCodeString_HasSectionIndexColorStatement() {
    let expectedString = "sectionIndexColor = UIColor(red: 0.909, green: 0.302, blue: 0.236, alpha: 1.000)"
    XCTAssertTrue(codeString.contains(expectedString))
  }
  
  func test_TableViewCodeString_HasSectionIndexBackgroundColorStatement() {
    let expectedString = "sectionIndexBackgroundColor = UIColor(red: 0.400, green: 0.800, blue: 1.000, alpha: 1.000)"
    XCTAssertTrue(codeString.contains(expectedString))
  }
  
  func test_TableViewCodeString_HasSectionIndexTrackingBackgroundColorStatement() {
    let expectedString = "sectionIndexTrackingBackgroundColor = UIColor(red: 0.216, green: 0.286, blue: 0.600, alpha: 1.000)"
    XCTAssertTrue(codeString.contains(expectedString))
  }
