...
//  func test_TableView_ReturnsCorrectInitString() {
//    let expectedString = "fooTableView = UITableView()"
//    XCTAssertTrue(codeString.contains(expectedString))
//  }
//  
//  func test_TableViewSetupString_HasTranslatesAutoresizingString() {
//    let expectedString = "fooTableView.translatesAutoresizingMaskIntoConstraints = false"
//    XCTAssertTrue(codeString.contains(expectedString))
//  }
//  
//  func test_TableViewSetupString_HasRowHeight() {
//    let expectedString = "fooTableView.rowHeight = 44"
//    XCTAssertTrue(codeString.contains(expectedString))
//  }
//  
